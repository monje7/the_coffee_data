...
export const guardarMuestra = async (req, res) => {
    try {
        ...
        let sql =  `INSERT INTO muestras(fecha_creacion, nombre, cantidad,lotes_id ) VALUES (?,?,?,?)`
        ...
        const [rows] = await pool.query(sql, [ data.fecha, data.nombre, data.cantidad,data.lotes_id ]); 
...
export const actualizarMuestra = async (req, res) => {
    try {
        ...
        let sql = `UPDATE muestras SET fecha_creacion='${data.fecha_creacion}',cantidad='${data.cantidad}',lotes_id='${data.lotes_id}' where id='${id}'`


        // let sql = `UPDATE muestras SET fecha_creacion='${fecha_creacion}',cantidad='${cantidad}',lotes_id='${lotes_id}' where id='${id}'`
